package com.pratham.biodiversity.ui.appIntro;
...
import com.pratham.biodiversity.ui.splash.SplashActivity;
import com.pratham.biodiversity.util.SharedPrefManager;
...
@EActivity(R.layout.activity_appintro)
public class AppIntroActivity extends AppCompatActivity {

    @ViewById(R.id.btn_next)
    public TextView btnNext;
    @ViewById(R.id.tv_getStarted)
