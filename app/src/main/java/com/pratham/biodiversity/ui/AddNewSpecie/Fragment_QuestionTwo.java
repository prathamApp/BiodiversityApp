...
public class Fragment_QuestionTwo extends Fragment {
    ...
    public void yesSelect(){
        ...
        cardYes.setCardBackgroundColor(getResources().getColor(R.color.colorPrimary));
